...
export default ()=>
{
    ...
    return <nav className="flex flex-col md:gap-5 md:flex-row">
        ...
        <Branch open={big} away={!big} id="hamburger">
            <BranchButton>Hamburger Menu</BranchButton>
            <BranchMenu className="duration-500">
                <Branch className="flex-1" away={big} id="upper">
                    <BranchButton
                        className="p-4 text-white bg-black transition-all duration-500"
                        classActive="text-black bg-white">
                            Sermons
                    </BranchButton>
                    <BranchMenu className={"bg-black flex flex-col duration-500 bg-red-500"}>
                ...
                <Branch className="flex-1" away={big} id="lower">
                    <BranchButton
                        className="p-4 text-white bg-black transition-all duration-500"
                        classActive="text-black bg-white">
                            Programs
                    </BranchButton>
                    <BranchMenu className={"bg-black flex flex-col duration-500"}>
                        <a href="/sermons/great-commandment-part-two" className="px-3 py-2 text-sm text-white font-bold">Great commandment</a>
                    </BranchMenu>
                </Branch>
            </BranchMenu>
